...
{
	class ContrastBasedAdaptiveQuantisationClass
	{
		
		private static void applyAdaptiveQuantisation(float[,] array, int numCoeffs)
		{
		...
		public static void Main (string[] args)
		{
			...
			applyAdaptiveQuantisation(yArray, 3);
			//compress chroma even more (98,4%)
			applyAdaptiveQuantisation(cbArray, 1);
			applyAdaptiveQuantisation(crArray, 1);
